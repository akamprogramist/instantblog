...
@section('content')
    ...
    <div class="box-white ms-3 me-3 mt-3 shadow-sm">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <a href="{{ url('/pages/') }}" class="btn btn-primary" role="button">@lang('admin.cancel')</a>      
            </div>
        </div>
    </div>
@endsection