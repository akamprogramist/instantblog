            ...
            <div class="row align-items-center">
                <div class="col">
                    <ul class="nav nav-justified">
                      ...
                      <li class="nav-item nav-pro">
                        <a class="nav-link active" href="{{ url('/followers/' . $user->username) }}">@lang('messages.new.followers') <span class="badge bg-secondary">{{ shortNumber($user->followers()->count()) }}</span></a>
                      </li>
                      <li class="nav-item nav-pro">
...
<div class="container-fluid mt-2">
    <div class="row">
        ...
        @empty
        <div class="col-md-12">
            <h5>@lang('messages.new.nofollowers')</h5>
        </div>
        @endforelse
    </div> 
</div>
