...
@section('content')
    ...
    <div class="row ms-3 me-3">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/contents/') }}">@lang('admin.published')</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="{{ url('/unpublished/') }}">@lang('admin.unpublished')</a>
            </li>
        </ul>
    </div>  
    <div class="row box-white ms-3 me-3 mt-2 shadow-sm">
        ...
        <div class="d-grid gap-2 d-md-block ps-0">
                ...
                <button name="mulbtn"  type="submit" class="btn btn-secondary btn-sm ms-2" value="Publish">@lang('admin.publish')</button>
            </form>
        </div>
    </div>
    <div class="row">
